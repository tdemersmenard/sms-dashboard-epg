...
INSERT INTO catalog_items (name, description, default_price, category, sort_order) VALUES
  ...
  ('Entretien hebdomadaire', 'Visite chaque semaine — ouverture + fermeture + produits de balancement inclus', 1799, 'Entretien', 3),
  ('Entretien aux 2 semaines', 'Visite aux 2 semaines — ouverture + fermeture + produits de balancement inclus', 1397, 'Entretien', 4),
